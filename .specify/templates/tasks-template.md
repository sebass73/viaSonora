...
- [ ] T010 Add constitution guard checks (auth pattern, ownership checks, privacy, i18n 5 locales)
...
- [ ] T019 [US1] Apply auth/ownership/privacy checks and translation keys in all 5 locales
